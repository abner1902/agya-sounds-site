...
const Section = styled.section`
  ...
  &::before {
    ...
    position: absolute;
    inset: 0;
    background-image: url('/fundo_op_art.jpg');
...
const ContentSide = styled.div`
  max-width: 530px;
  animation: ${slideInLeft} 1.2s cubic-bezier(0.1, 0.7, 0.3, 1) forwards;
  position: relative;
  z-index: 2;
`;
...
const SliderSide = styled.div`
  ...
  animation: ${slideInRight} 1.2s cubic-bezier(0.1, 0.7, 0.3, 1) forwards;
  position: relative;
  z-index: 2;
